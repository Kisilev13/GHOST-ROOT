...
<section class="gr-hero">
    ...
    <div class="gr-hero-copy"><p class="gr-eyebrow">AUTONOMOUS IDENTITIES. UNKNOWN ORIGIN.</p><h1>YOU WERE<br>NEVER SUPPOSED<br>TO <span>FIND THEM.</span></h1><p class="gr-hero-description">3,333 identities. A network that disappeared.<br>A signal that never stopped.</p><div class="gr-actions"><a class="gr-button gr-button-primary" href="<?php echo esc_url(home_url('/initialize/')); ?>">INITIALIZE <span aria-hidden="true">↗</span></a><a class="gr-text-link" href="<?php echo esc_url(home_url('/archive/')); ?>">ACCESS ARCHIVE <span aria-hidden="true">→</span></a></div></div>
    <div class="gr-hero-portrait" aria-label="Recovered identity preview">
        ...
        <div class="gr-scanline" aria-hidden="true"></div><span class="gr-art-label">PROCEDURAL RECONSTRUCTION / ART PENDING</span>
