...
<div class="gr-results-bar"><span><?php global $wp_query; echo (int)$wp_query->found_posts; ?> MATCHING RECORDS</span><span>PROCEDURAL PORTRAITS / FINAL ART PENDING</span></div>
